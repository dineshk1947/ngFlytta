            ...
            return $scope.$watchCollection(collectionString, function(collection) {
              ...
              for (attrKey in attr) {
                ...
                if (attrKey === 'sliderId') {
                  ...
                  // <div data-toggle="modal" data-target="#imageModal"></div>
                  slides = angular.element('<ul class="slides" data-toggle="modal" data-target="#imageModal" style="cursor:zoom-in;"></ul>');
